namespace OrderForm
{
    partial class FormMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cbxField.Items.AddRange(new object[] {"全部订单", "ID", "客户名"});
            ...
            this.dbvOrders.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {this.orderIdDataGridViewTextBoxColumn, this.customerNameDataGridViewTextBoxColumn, this.createTimeDataGridViewTextBoxColumn, this.totalPriceDataGridViewTextBoxColumn});
            ...
            this.dbvItems.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {this.goodsNameDataGridViewTextBoxColumn, this.dataGridViewTextBoxColumn2, this.UnitPrice, this.totalPriceDataGridViewTextBoxColumn1});
